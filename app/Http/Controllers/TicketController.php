...
/**
 * Generic support-ticket controller.
 *
 * NOTE: This controller is not bound to any route in the current route files
 * (the user- and admin-facing flows live in App\Http\Controllers\User and
 * App\Http\Controllers\Admin respectively). It is kept as a conventional,
 * self-contained ticket controller for completeness.
 */
class TicketController extends Controller
{
    ...
    /**
     * Persist a new ticket and its initial message.
     */
    ...
    /**
     * Show a ticket owned by the authenticated user.
     */
