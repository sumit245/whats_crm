        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="submit" id="addTagSubmitBtn" class="btn btn-primary">{{__('Add')}}</button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
document.querySelector('form[action="{{ route('tag.store') }}"]').addEventListener('submit', function() {
    const btn = document.getElementById('addTagSubmitBtn');
    btn.disabled = true;
