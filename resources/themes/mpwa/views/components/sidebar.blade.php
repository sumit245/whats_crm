    ...
    <div class="app-sidebar">
        ...
        <div class="app-menu">
            <ul class="accordion-menu">
                ...
                <li class="{{request()->is('flows*') ? 'active-page' : ''}}">
                    <a href="{{ route('flows.index') }}" class=""><i class="material-icons-two-tone">account_tree</i>{{ __('Chatbot Flows') }}</a>
                </li>
                <li class="{{request()->is('segments*') ? 'active-page' : ''}}">
                    <a href="{{ route('segments.index') }}" class=""><i class="material-icons-two-tone">filter_list</i>{{ __('Segments') }}</a>
                </li>
